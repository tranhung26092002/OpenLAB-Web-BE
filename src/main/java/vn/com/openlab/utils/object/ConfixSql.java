...
public class ConfixSql {
    ...
    public interface Product {
        ...
        // Truy vấn để lấy tất cả sản phẩm của người dùng với phân trang và từ khóa tìm kiếm
        public static final String GET_ALL_MY_PRODUCTS = "SELECT p FROM Product p " +
                "JOIN p.users u " +
                "WHERE u.id = :userId " +
