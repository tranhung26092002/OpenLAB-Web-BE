package vn.com.openlab.utils.object;
...
public class MessageKeys {
    ...
    // user-product
    public static final String MESSAGE_ERROR_FORBIDDEN = "message.error.forbidden";
    public static final String MESSAGE_SUCCESS_PRODUCT_ADDED = "message.success.product.added";
    public static final String MESSAGE_ERROR_ADD_PRODUCT = "message.error.add.product";
    public static final String MESSAGE_ERROR_PRODUCT_NOT_FOUND = "message.error.product.not.found";
    public static final String MESSAGE_SUCCESS_PRODUCT_REMOVED = "message.success.product.removed";
    public static final String MESSAGE_ERROR_REMOVE_PRODUCT = "message.error.remove.product";
}
